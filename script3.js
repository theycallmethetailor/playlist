document.addEventListener("DOMContentLoaded", function() {
  ...
  const albumnItself = document.querySelector('.album-itself')
  console.log(albumnItself);
    ...
    .then(function(jSONalbums) {
      ...
      for (var i = 0; i < jSONalbums.results.length; i++) {
        ...
        newAlbumnImage.addEventListener("click", function(e) {
          ...
          albumnInfo = document.createElement('span');
          albumnInfo.className = "m-2 track d-block";
          albumnInfo.textContent =   `${artist}: ${title}`;
          albumnItself.appendChild(newTrack);
